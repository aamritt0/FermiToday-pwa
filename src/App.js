...
const EventCard = ({ item, index, isDark }) => {
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl overflow-hidden shadow-lg mb-4 flex transition-all duration-300 hover:shadow-xl ${
...
export default function App() {
          ...
          registration.addEventListener("updatefound", () => {
            ...
            newWorker.addEventListener("statechange", () => {
              if (
                ...
                showNotification(
                  "📱 Nuova versione disponibile! Ricaricando...",
                  "info"
                );
  ...
  const fetchEvents = React.useCallback(
    async (isRefresh = false, targetSection, targetProfessor, targetDate) => {
  ...
  return (
    ...
    >
      ...
      {/* View Mode Selector */}
      <div
        className={`sticky top-[88px] z-30 transition-colors duration-300 ${
          isDark ? "bg-zinc-900" : "bg-white"
        ...
        >
          <div className="flex gap-3">
            <div className="flex-1">
              <label
                className={`block text-xs font-semibold uppercase tracking-wide mb-2 transition-colors duration-300 ${
                  isDark ? "text-gray-400" : "text-gray-600"
                }`}
              >
                Classe
      ...
      <div
        className={`transition-colors duration-300 ${
          isDark ? "bg-zinc-900" : "bg-white"
        } px-6 py-3 border-b ${isDark ? "border-zinc-800" : "border-gray-200"}`}
      >
        <div className="flex gap-2">
          <button
      ...
      {showSettings && (
        <>
          ...
          <div
            className={`fixed inset-x-0 bottom-0 z-50 sm:inset-0 sm:flex sm:items-center sm:justify-center animate-slide-up`}
          >
            <div
              className={`w-full sm:max-w-lg sm:rounded-2xl transition-colors duration-300 ${
                isDark ? "bg-zinc-900" : "bg-white"
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      Basta inserire la classe o il nome del professore per
                      vedere eventuali modifiche all'orario di oggi. NON
                      UFFICIALE
                    </p>
                    <p
      ...
      {notification && (
        <div
          className={`fixed top-20 left-4 right-4 z-50 flex items-center gap-3 p-4 rounded-xl shadow-2xl animate-slide-down ${
      ...
      {showIOSInstall && (
        <>
          ...
          >
            ...
            <div
              className={`space-y-3 mb-4 p-4 rounded-xl ${
